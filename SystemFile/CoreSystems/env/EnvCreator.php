...
class EnvCreator
{
    ...
    public function AutoLoadExamination(){
        $autoloader = require dirname(__FILE__)."/../../../vendor/autoload.php";
        $result = $autoloader->findFile("TurboCore\SystemFileReader");
    ...
    protected function TableCreator()
    {
        ...
        $this->dbc->Initializer()->Self("CREATE TABLE IF NOT EXISTS preuser(regdate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, email VARCHAR(256) NOT NULL, uuid VARCHAR(40) NOT NULL PRIMARY KEY)")->Run();
